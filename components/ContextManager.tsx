...
import { ICP, ProductInfo, MarketFeedback, ContextData } from '../types';
import { Plus, Edit2, Trash2, Users, Package, TrendingUp, X, Save } from 'lucide-react';
...
type ActiveTab = 'icp' | 'product' | 'market';
